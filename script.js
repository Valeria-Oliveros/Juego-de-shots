...
function actualizarFichasTablero() {
 ...
 jugadores.forEach((jugador, idx) => {
  ...
  // Corregido: Uso de min() para que el tamaño de la ficha se adapte
  ficha.style.width = "min(4vw, 38px)";
  ficha.style.height = "min(4vw, 38px)";
  ...
  // Corregido: Uso de min() para que el tamaño de la fuente se adapte
  ficha.style.fontSize = "min(2vw, 22px)";
  ficha.style.textAlign = "center";
  // Corregido: Uso de min() para que la altura de la línea se adapte
  ficha.style.lineHeight = "min(4vw, 38px)";
